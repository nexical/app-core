...
export function AuthShell({ children }: { children: React.ReactNode }) {
    return (
        <div className="auth-page-container min-h-screen flex flex-col items-center justify-center p-4 bg-muted/20 relative overflow-hidden" data-testid="auth-shell">
