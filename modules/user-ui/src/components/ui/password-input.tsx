...
export const PasswordInput = React.forwardRef<HTMLInputElement, PasswordInputProps>(
    ({ className, showStrengthMeter, onScoreChange, onChange, ...props }, ref) => {
        ...
        const getStrengthColor = (score: number) => {
            switch (score) {
                case 0: return "password-strength-fill-0"
                case 1: return "password-strength-fill-1"
                case 2: return "password-strength-fill-2"
                case 3: return "password-strength-fill-3"
                case 4: return "password-strength-fill-4"
                default: return "password-strength-fill-0"
            }
        }

        const getStrengthLabel = (score: number) => {
            switch (score) {
                case 0: return t("user.components.password_input.strength.too_weak")
                case 1: return t("user.components.password_input.strength.weak")
                case 2: return t("user.components.password_input.strength.fair")
                case 3: return t("user.components.password_input.strength.good")
                case 4: return t("user.components.password_input.strength.strong")
                default: return ""
            }
        }
                ...
                <div className="password-input-wrapper relative">
                    ...
                    >
                        ...
                        <span className="password-reader-only">
                            {showPassword ? t("user.components.password_input.toggle.hide") : t("user.components.password_input.toggle.show")}
                        </span>
                    </Button>
                </div>
                ...
                {showStrengthMeter && props.value && String(props.value).length > 0 && (
                    <div className="password-strength-meter">
                        ...
                        <div className="password-strength-text-container">
                            <span className={cn("password-strength-label", strength < 2 ? "password-strength-label-weak" : "password-strength-label-normal")}>
