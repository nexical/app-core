...
export function ConfirmFormDeletion({
    ...
    const isMatch = confirmationInput.trim() === resourceIdentifier || confirmationInput.trim() === 'DELETE';
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="space-y-3">
                        ...
                        <p>
                            Please type <span className="font-mono font-bold select-all">{resourceIdentifier}</span> (or 'DELETE') to confirm.
                        </p>
                        <Input
