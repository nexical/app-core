    ...
    return (
        <Dialog open={open} onOpenChange={(isOpen) => {
            ...
            <DialogContent data-testid="create-token-dialog-content">
                <DialogHeader>
                    <DialogTitle data-testid="create-token-dialog-title">{t("user.tokens.create_dialog.title", "Create Personal Access Token")}</DialogTitle>
                    <DialogDescription>
                        {t("user.tokens.create_dialog.description", "Create a token to access the API. You will only see it once.")}
                    </DialogDescription>
                </DialogHeader>
                ...
                {!rawKey ? (
                    ...
                    <div className="space-y-4">
                        <div className="p-4 rounded-md bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 flex items-start gap-2">
                            ...
                            <p className="text-sm">
                                {t("user.tokens.warning_copy", "Make sure to copy your personal access token now. You won't be able to see it again!")}
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <Input value={rawKey || ""} readOnly className="font-mono" data-testid="create-token-value" />
                                <Button size="icon" variant="outline" onClick={handleCopy} data-testid="create-token-copy">
