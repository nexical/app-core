...
2.  **Creative Permutation (The Core Task)**: For *each* endpoint, think outside the box. Do not just list the obvious happy path. **Invent scenarios** that might break the system or reveal hidden logic gaps.
...
3.  **Future-Proofing**: Document logical outcomes that *should* happen, even if you aren't 100% sure the code currently handles them perfectly. We want to test for robustness.
