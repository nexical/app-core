...
2. **Identify Configurations:** Determine if different system modes affect these workflows. If so, document the behavior for *each* mode.
...
4. **Future-Proofing:** Document logical outcomes that *should* happen, even if you aren't 100% sure the code currently handles them perfectly. We want to test for robustness.
...
* *Critique:* "Did I miss an edge case?"
* *Critique:* "Did I account for what happens in a particular system mode?"
* *Action:* Integrate these missing edge cases into the final document.
...
**Reference Structure:**
*Use this content as your "Gold Standard" for formatting, tone, and depth.*
