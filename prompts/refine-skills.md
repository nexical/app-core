...
*   **IF** a pattern in the codebase contradicts a Skill, prioritize the **Constitution** (`ARCHITECTURE.md`, etc.). If the Code violates the Constitution, specificy that the *Code* is wrong, do not lower the standards of the Skill.
...
*   **Step A: Analysis**
    *   Read the `SKILL.md`.
    *   Scan the codebase for *successful* implementations of this skill.
    *   Scan the codebase for *failed* or *messy* implementations (Anti-patterns).
