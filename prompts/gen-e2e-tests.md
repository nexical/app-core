...
* **Immutability:** You may NOT modify the `{{ root_path }}tests/e2e/CASES.md` file to make it "easier" or "match the current code." You may only propose *additions* if you find gaps.
...
* *Self-Correction:* "Did I cover the extreme edge case?"

* *Expansion:* If you identify a critical edge case missing from the `{{ root_path }}tests/e2e/CASES.md` file (e.g., "Network Offline"), **ADD** a test case for it and mark it with a comment `// ADDED: Edge case not in original spec`.
