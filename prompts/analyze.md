...
* **Boundaries:** Does the module avoid importing internal files from *other* modules? (Should use public package imports or shared `lib` hooks).
...
* Use comments to explain *why* the change was made (referencing the specific MD file).
