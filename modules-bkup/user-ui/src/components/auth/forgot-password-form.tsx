  ...
  const onSubmit = async (values: ForgotFormValues) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        t('user.auth.forgot_password.error.unexpected');
      ...
      <Card className="auth-card">
        <CardHeader>
          <CardTitle className="auth-card-title">
            {t('user.auth.forgot_password.success_title')}
          </CardTitle>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form-container" method="POST">
          ...
          <div className="auth-form-group">
            ...
            <Input
              id="email"
              type="email"
              placeholder={t('user.auth.forgot_password.email_placeholder', {
          ...
          >
            {isSubmitting
              ? t('user.auth.forgot_password.submitting_button')
              : t('user.auth.forgot_password.submit_button')}
          </Button>
