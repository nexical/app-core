...
## 1. Goal
To produce a clear "Feature Specification" or "Logical Flow" document *before* any implementation planning occurs.
...
**DO NOT** plan manual implementation for Services or API Routes. These are generated by `npx arc gen:api`.
...
*   **`[Action][Entity]Action`**: Orchestrates services.
    *   *Purpose*: ...
    *   *Logic*: [Business intent description]
