...
export class HookSystem {
    private static listeners = new Map<string, ((data: any, context?: any) => any | Promise<any>)[]>();
     ...
     */
    static on<T, C = any>(event: string, handler: (data: T, context?: C) => void | T | Promise<void | T>): void {
