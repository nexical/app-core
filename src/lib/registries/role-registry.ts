...
export interface RolePolicy {
    ...
    redirect?(context: AstroGlobal | APIContext, input: Record<string, any>, data?: any): Promise<Response | undefined | void | string>;
}
...
class RoleRegistry {
    ...
    public async check(name: string, context: AstroGlobal | APIContext, input: Record<string, any>, data?: any): Promise<void> {
