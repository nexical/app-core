    ...
    beforeEach(() => {
        tableMock = {
            getAllColumns: vi.fn().mockReturnValue([
                { id: 'name', accessorFn: () => { }, getCanHide: () => true, getIsVisible: () => true, toggleVisibility: vi.fn() },
                { id: 'role', accessorFn: () => { }, getCanHide: () => true, getIsVisible: () => false, toggleVisibility: vi.fn() },
