...
- **Tip**: If you *must* test the email content, use the `HookSystem` to verify the `core.email.sent` event on the server side (Integration tests) rather than trying to read it in the UI.
