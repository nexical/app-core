...
export class ModelParser {
    static parse(modelsYamlPath: string): { models: ModelDef[], enums: EnumConfig[], config: GlobalConfig } {
            ...
            for (const fieldName in config.fields) {
                ...
                model.fields[fieldName] = {
                    ...
                    enumValues: isEnum ? (() => {
                        ...
                        if (typeof val === 'object' && val !== null && Array.isArray(val.values)) return val.values;
