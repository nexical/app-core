...
describe('FunctionPrimitive', () => {
    ...
    it('should reconcile body statements (append new string)', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'function test() { console.log("initial"); }');
    ...
    it('should skip existing identical string statements', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'function test() { console.log("exists"); }');
    ...
    it('should enforce non-default variable declaration', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'function test() { const foo = "old"; }');
    ...
    it('should respect user changes for default variable declaration', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'function test() { const foo = "user-changed"; }');
    ...
    it('should reconcile if statement by condition', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'function test() { if (check) { old(); } }');
    ...
    it('should validate correctly', () => {
        const testProject = createTestProject();
        const sourceFile = testProject.createSourceFile('test.ts', 'async function test(): Promise<void> {}');
        const func = sourceFile.getFunction('test')!;
