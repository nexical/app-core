...
describe('TestBuilder', () => {
    const userModel: ModelDef = {
        ...
        db: true,
        fields: {
            id: { type: 'String', isRequired: true, isList: false, api: true, attributes: ['@id', '@default(cuid())'] },
    ...
    const postModel: ModelDef = {
        ...
        db: true,
        fields: {
            id: { type: 'Int', isRequired: true, isList: false, api: true, attributes: ['@id', '@default(autoincrement())'] },
            ...
            author: { type: 'User', isRequired: true, isList: false, api: false, isRelation: true, attributes: ['@relation(fields: [authorId])'] }
        },
    ...
    it('should generate GET tests with dependency setup', () => {
        ...
        const text = sourceFile.getFullText();
        expect(text).toContain('const target = await Factory.create(\'post\', { ...{"title":"title_test"}, author: { connect: { id: actor.id } } });');
