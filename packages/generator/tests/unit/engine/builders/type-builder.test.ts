...
describe('TypeBuilder', () => {
    ...
    it('should generate enums as const object and type', () => {
        const enums: EnumConfig[] = [
            {
                name: 'SiteRole',
                members: [{ name: 'ADMIN', value: 'ADMIN' }, { name: 'USER', value: 'USER' }]
            }
        ];
        ...
        expect(variable?.getDeclarations()[0].getType().getText()).toContain('{ readonly ADMIN: "ADMIN"; readonly USER: "USER"; }');
